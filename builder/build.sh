...
HYPRIOT_IMAGE_NAME="ubikube-rpi-${HYPRIOT_IMAGE_VERSION}.img"
...
if [ ! -f "${BUILD_RESULT_PATH}/${RAW_IMAGE}.zip" ]; then
  wget -q -O "${BUILD_RESULT_PATH}/${RAW_IMAGE}.zip" "https://github.com/fest-research/image-builder-raw/releases/download/${RAW_IMAGE_VERSION}/${RAW_IMAGE}.zip"
fi
